...
impl TryFrom<PrivateKeyDer<'_>> for SigningKey1337 {
    ...
    fn try_from(value: PrivateKeyDer<'_>) -> Result<Self, Self::Error> {
        match value {
            PrivateKeyDer::Pkcs8(der) => {
                ...
                let algo_oid_arcs: Vec<OidArc> = private_key_info
                    .algorithm
                    .oid
                    .arcs()
                    .collect();
...
fn trim_leading_zeroes<'a>(mut buf: &'a [u8]) -> &'a [u8] {
...
impl SigningKey for SigningKey1337 {
    ...
    fn algorithm(&self) -> SignatureAlgorithm {
        match self {
            SigningKey1337::RsaPss { .. } => SignatureAlgorithm::RSA,
            SigningKey1337::Ecdsa(_, _) => SignatureAlgorithm::ECDSA,
            SigningKey1337::Ed25519(_) => SignatureAlgorithm::ED25519,
        }
    }
}
...
impl Signer for SigningKey1337 {
    fn sign(&self, message: &[u8]) -> Result<Vec<u8>, rustls::Error> {
        match self {
            SigningKey1337::RsaPss {
                n,
                d,
                key_size,
                hash_algo,
            ...
            SigningKey1337::Ecdsa(private_key, scheme) => {
            ...
            SigningKey1337::Ed25519(sk) => signature::sign(
            ...
            .map_err(|_| rustls::Error::General(String::from("signing error")))
            .map(|sig| {
                if let signature::Signature::Ed25519(sig) = sig {
                    sig.as_bytes().to_vec()
                } else {
                    unreachable!()
                }
    ...
    fn scheme(&self) -> SignatureScheme {
        match self {
            ...
            SigningKey1337::Ecdsa(_, EcdsaSignatureScheme::ECDSA_NISTP256_SHA256) => {
                SignatureScheme::ECDSA_NISTP256_SHA256
            }
            // SigningKey1337::Ecdsa(_, EcdsaSignatureScheme::ECDSA_NISTP384_SHA384) => {
            //     SignatureScheme::ECDSA_NISTP384_SHA384
            // }
            // SigningKey1337::Ecdsa(_, EcdsaSignatureScheme::ECDSA_NISTP521_SHA512) => {
            //     SignatureScheme::ECDSA_NISTP521_SHA512
            // }
            SigningKey1337::Ed25519(_) => SignatureScheme::ED25519,
        }
    }
}
